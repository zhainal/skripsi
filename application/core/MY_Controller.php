...
class MY_Controller extends CI_Controller
{
        ...
        if (!is_ajax()) {
            ...
            if (is_siswa()) {
                ...
                if (empty($kelas_aktif)) {
                    exit('Kelas aktif Anda tidak ditemukan, segera hubungi Administrator E-Learning.');
                }
    ...
    function check_tgl_tampil($tgl_tampil = '')
    {
        ...
        if (!$valid) {
            $this->form_validation->set_message('check_tgl_tampil', 'Tanggal Tampil tidak valid.');
            return false;
        }
