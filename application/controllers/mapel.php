...
class Mapel extends MY_Controller
{
    ...
    function add()
    {
        if ($this->form_validation->run('mapel/add') == TRUE AND !is_demo_app()) {
            ...
            $this->session->set_flashdata('mapel', get_alert('success', 'Mata Pelajaran baru berhasil disimpan.'));
    ...
    function edit($segment_3 = '', $segment_4 = '')
    {
        ...
        if ($this->form_validation->run('mapel/edit') == TRUE AND !is_demo_app()) {
            ...
            $this->session->set_flashdata('mapel', get_alert('success', 'Mata Pelajaran berhasil diperbaharui.'));
            redirect($uri_back);
        }
