...
class Welcome extends MY_Controller
{
    function index()
    {
        ...
        if (is_admin()) {
            ...
            $data['jml_siswa_aktif']    = $this->siswa_model->count('aktif');
            $data['jml_siswa_pending']    = $this->siswa_model->count('pending');
            $data['jml_siswa_blok']    = $this->siswa_model->count('blok');
            $data['jml_siswa_alumni']    = $this->siswa_model->count('alumni');
            $data['jml_pengajar']         = $this->pengajar_model->count('total');
            $data['jml_pengajar_aktif'] = $this->pengajar_model->count('aktif');
            $data['jml_pengajar_pending'] = $this->pengajar_model->count('pending');
            $data['jml_pengajar_blok'] = $this->pengajar_model->count('blok');
        ...
        switch ($segment_3) {
            case 'siswa':
                ...
                if ($this->form_validation->run() == true) {
                    ...
                    # redirect berhasil
                    if (empty($data_gagal)) {
                        $this->session->set_flashdata('hapus_data', get_alert('success', 'Data Siswa Berhasil Dihapus.'));
                    } else {
            ...
            case 'pengajar':
                ...
                if ($this->form_validation->run() == true) {
                    ...
                    # redirect berhasil
                    if (empty($data_gagal)) {
                        $this->session->set_flashdata('hapus_data', get_alert('success', 'Data Pengajar Berhasil Dihapus.'));
                    } else {
            ...
            case 'tugas':
                ...
                if ($this->form_validation->run() == true) {
                    ...
                    # redirect berhasil
                    if (empty($data_gagal)) {
                        $this->session->set_flashdata('hapus_data', get_alert('success', 'Data Tugas Berhasil Dihapus.'));
                    } else {
