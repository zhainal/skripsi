...
class Login extends MY_Controller
{
        ...
        if ($sebagai == 'siswa') {
            if ($this->form_validation->run('register/siswa') == true) {
                ...
                if ($status_id == 1) {
                    ...
                    $pesan = "Pendaftaran sebagai Siswa Berhasil, silahkan " . anchor('login/index', 'MASUK') . " ke sistem E-Learning dengan menggunakan Username & Password Anda.";
                } else {
                    ...
                    $pesan = "Pendaftaran sebagai Siswa Berhasil, mohon menunggu pengaktifan akun oleh Administrator.";
                }
        ...
        elseif ($sebagai == 'pengajar') {
            if ($this->form_validation->run('register/pengajar') == true) {
                ...
                if ($status_id == 1) {
                    ...
                    $pesan = "Pendaftaran sebagai Pengajar Berhasil, silahkan " . anchor('login/index', 'MASUK') . " ke sistem E-Learning dengan menggunakan Username & Password Anda.";
                } else {
                    # kirim email registrasi
                    ...
                    $pesan = "Pendaftaran sebagai Pengajar Berhasil, mohon menunggu pengaktifan akun oleh Administrator.";
                }
    ...
    function lupa_password()
    {
        ...
        if ($this->form_validation->run('lupa_password') == true) {
            ...
            $this->session->set_flashdata('lupa_password', get_alert('success', 'Link Reset Password berhasil dikirimkan ke Email Anda.'));
    ...
    function reset_password($kode = '')
    {
        ...
        if (empty($login)) {
            $this->session->set_flashdata('lupa_password', get_alert('warning', 'Reset kode tidak benar, mohon periksa kembali.'));
            redirect('login/lupa_password');
        }
    ...
    {
        $this->session->set_flashdata('login', get_alert('warning', "Session Login Anda telah habis, silahkan Login kembali."));
        $this->logout();
    }
}
